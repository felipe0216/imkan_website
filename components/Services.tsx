    ...
    <section id="services" className="relative py-24 bg-background-dark">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]">
          ...
          <div className="md:col-span-2 glass-card rounded-2xl p-8 relative group overflow-hidden hover:border-primary/50 transition-colors duration-500 flex flex-col justify-between">
          ...
          <div className="glass-card rounded-2xl p-8 relative group overflow-hidden hover:border-emerald-500/50 transition-colors duration-500 flex flex-col justify-between">
          ...
          {/* Card 3: Agentic AI */}
          <div className="glass-card rounded-2xl p-8 relative group overflow-hidden hover:border-purple-500/50 transition-colors duration-500 flex flex-col justify-between">
