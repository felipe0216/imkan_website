    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass-nav transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
            <button className="relative overflow-hidden bg-primary hover:bg-white hover:text-background-dark text-background-dark font-bold px-5 py-2.5 rounded-lg text-sm transition-all duration-300 shadow-[0_0_15px_rgba(37,226,244,0.3)] hover:shadow-[0_0_25px_rgba(37,226,244,0.6)] group">
