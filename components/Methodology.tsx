    ...
    <section id="methodology" className="relative w-full px-6 py-24 bg-background-dark overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative grid md:grid-cols-[1fr_auto_1fr] gap-8 md:gap-0 items-start">
          ...
          {/* Center Line (Desktop) */}
          <div className="hidden md:flex flex-col items-center justify-self-center h-full absolute left-1/2 -translate-x-1/2 top-0 bottom-0 z-0">
            <div className="w-px h-full bg-gradient-to-b from-transparent via-primary/50 to-transparent"></div>
          </div>
